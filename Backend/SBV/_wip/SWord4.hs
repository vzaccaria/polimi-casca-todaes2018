...
module Backend.SBV.SWord4 where
...
-- No instance for (S.Splittable S.SWord8 SWord4)
-- it cannot be implemented without access to `svExtract` from the internal Data/SBV/Core/Operations.hs
